...
## Task ID: task-20260113-150839-7107a80c
## Requirement: Implement HealthDataController endpoints in server/src/health-data/health-data.controller.ts                                                                                                            
                                                                                                                                                                                                          
  The HealthDataService already exists at server/src/health-data/health-data.service.ts with these methods:                                                                                               
  - createBiomarker(data)                                                                                                                                                                                 
  - createManyBiomarkers(data[])                                                                                                                                                                          
  - getBiomarkersByUser(userId, options)                                                                                                                                                                  
  - getBiomarkersByDateRange(userId, startDate, endDate)                                                                                                                                                  
                                                                                                                                                                                                          
  Create these REST endpoints with proper JWT auth and RBAC:                                                                                                                                              
                                                                                                                                                                                                          
  1. GET /health-data/biomarkers/:userId - Get paginated biomarkers (CLINICIAN: any user, PATIENT: own only)                                                                                              
  2. POST /health-data/biomarkers - Create single biomarker entry (CLINICIAN only)                                                                                                                        
  3. POST /health-data/sync - Batch create biomarkers for wearable device sync (CLINICIAN only)                                                                                                           
                                                                                                                                                                                                          
  Requirements:                                                                                                                                                                                           
  - Use @UseGuards(JwtAuthGuard, RolesGuard) for all endpoints                                                                                                                                            
  - Validate userId is UUID                                                                                                                                                                               
  - Create request/response DTOs with class-validator decorators                                                                                                                                          
  - PATIENT role can only access their own data (compare JWT userId with param)                                                                                                                           
