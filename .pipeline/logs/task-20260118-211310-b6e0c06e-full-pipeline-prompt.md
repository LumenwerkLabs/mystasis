...
## Task ID: task-20260118-211310-b6e0c06e
## Requirement: Implement AlertsController following the HealthDataController pattern.                                                                                         
                                                                                                                                                                 
  The AlertsService already exists at src/modules/alerts/alerts.service.ts with these methods:                                                                   
  - create(), findAll(), findOne(), getActiveAlerts(), acknowledge(), dismiss(), resolve()                                                                       
                                                                                                                                                                 
  Create:                                                                                                                                                        
  1. TDD spec file: alerts.controller.spec.ts (follow health-data.controller.spec.ts pattern)                                                                    
  2. DTOs in src/modules/alerts/dto/:                                                                                                                            
     - create-alert.dto.ts (userId, type, severity, title, message, value?, threshold?)                                                                          
     - get-alerts-query.dto.ts (status?, severity?, page?, limit?)                                                                                               
  3. alerts.controller.ts with endpoints:                                                                                                                        
     - GET /alerts/:userId - list alerts with filters (PATIENT own, CLINICIAN all)                                                                               
     - GET /alerts/:userId/active - active alerts only                                                                                                           
     - GET /alerts/:id - single alert                                                                                                                            
     - POST /alerts - create alert (CLINICIAN only)                                                                                                              
     - PATCH /alerts/:id/acknowledge - mark acknowledged (PATIENT own, CLINICIAN)                                                                                
     - PATCH /alerts/:id/dismiss - dismiss alert (PATIENT own, CLINICIAN)                                                                                        
     - PATCH /alerts/:id/resolve - resolve alert (CLINICIAN only)                                                                                                
                                                                                                                                                                 
  Access control: Patients can only access/modify their own alerts. Use JwtAuthGuard, RolesGuard, @Roles(), @CurrentUser(), ParseUUIDPipe. Update                
  alerts.module.ts to register the controller. 
